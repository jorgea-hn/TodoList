        ...
        <div className="bg-slate-500 px-4 py-3 mb-2 rounded-md flex justify-between items-center">
            <div className="flex flex-col">
                ...
                )}
                {
                    ...
                    <textarea placeholder={task.description} className="p-2 bg-slate-500 border-none outline-none text-green-400 w-full" rows={1} onChange={e=> setNewDescription(e.target.value)}></textarea>
                )}
            ...
            <div className=" flex justify-between gap-x-2">
                ...
                <button className={"text-white rounded-md p-2 " + (task.done ? "bg-gray-800" : "bg-green-500")} onClick={() => handleTaskDone(task.id)}>{task.done ? "Desmarcar" : "Marcar"}</button>
